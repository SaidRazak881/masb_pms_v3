...
export default function Login() {
  ...
  return (
    <main className="flex min-h-screen bg-slate-950">
      {/* ─── Left: Midnight Slate brand panel ─────────────────────────────── */}
      <aside className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-slate-950 p-12 lg:flex">
        <div className="pointer-events-none absolute inset-0">
          ...
          <div className="absolute -bottom-40 -right-24 h-96 w-96 rounded-full bg-blue-700/20 blur-3xl" />
          <div
        ...
        <div className="relative">
          <img
            src="/mimos-academy-logo-white.svg"
            alt="MIMOS Academy"
        ...
        <div className="relative">
          <h1 className="max-w-md text-4xl font-extrabold leading-tight tracking-tight text-white">
            Kawalan Eksekutif <span className="text-violet-400">R1 · R2 · R3</span> dalam satu platform.
          </h1>
          ...
          <div className="mt-8 space-y-3">
            {[
              ...
              <div key={f.label} className="flex items-center gap-3">
                <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-slate-800/80 text-violet-300 ring-1 ring-slate-700/60">
        ...
        <p className="relative text-xs text-slate-600">
          © 2026 MIMOS Academy · Enterprise PMS v1.0.3
        </p>
      </aside>
        ...
        <div className="w-full max-w-md">
          <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-xl">
            ...
            <form onSubmit={submit} className="mt-6 space-y-4">
              <label className="block">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-11 w-full rounded-lg border border-slate-200 bg-slate-50/60 pl-10 pr-3 text-sm text-slate-900 placeholder-slate-400 transition-colors focus:border-violet-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-violet-500/20"
                  />
                </div>
              </label>
              ...
              <button
                disabled={loading}
                className="flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-slate-900 font-semibold text-white transition-colors hover:bg-slate-800 disabled:opacity-60"
              >
                {loading ? (
                  <>
